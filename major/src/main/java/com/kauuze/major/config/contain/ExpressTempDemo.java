...
public class ExpressTempDemo {
    ...
    private static String calcAuthorization(String source, String datetime)
            throws NoSuchAlgorithmException, InvalidKeyException {
        String signStr = "x-date: " + datetime + "\n" + "x-source: " + source;
        Mac mac = Mac.getInstance("HmacSHA1");
        Key sKey = new SecretKeySpec(ExpressTempDemo.secretKey.getBytes(StandardCharsets.UTF_8), mac.getAlgorithm());
        mac.init(sKey);
        byte[] hash = mac.doFinal(signStr.getBytes(StandardCharsets.UTF_8));
        String sig = new BASE64Encoder().encode(hash);

        return "hmac id=\"" + ExpressTempDemo.secretId + "\", algorithm=\"hmac-sha1\", headers=\"x-date x-source\", signature=\"" + sig + "\"";
    }
    ...
    public String queryExpress(String expressNo, String expressName) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
        //云市场分配的密钥Id
//        String secretId = ;
        //云市场分配的密钥Key
//        String secretKey = "xxxx";
        ...
        queryParams.put("kddh", expressNo);
        queryParams.put("kdmc", expressName);
        // body参数
