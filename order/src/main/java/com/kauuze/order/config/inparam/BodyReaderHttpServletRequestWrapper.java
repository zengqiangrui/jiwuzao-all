package com.kauuze.order.config.inparam;
...
import com.kauuze.order.include.JsonUtil;
import com.kauuze.order.include.StringUtil;
...
public class BodyReaderHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    public BodyReaderHttpServletRequestWrapper(HttpServletRequest request) throws IOException {
        ...
        logRepository.save(new Log(null,System.currentTimeMillis(),log, "order",false, DateTimeUtil.covertDateView(System.currentTimeMillis())));
    }
